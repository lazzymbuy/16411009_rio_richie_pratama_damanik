<?php
error_reporting(0);
//this function created by Richie Damanik
session_start();
...
<head>
	...
	<meta name="author" content="Richie Damanik">
	<!-- end: Meta -->
...
<!--END HEADER MENU ATAS -->		
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
					<a href="index.php?halaman=main">Home</a> 
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="http://richiedamanik.com/" alt="richiedamanik.com">richiedamanik.com</a></span>
